...
describe('readFileAsynchronously', () => {
  ...
  test('should return null if file does not exist', async () => {
    ...
    const expectedFullPath = '/mock/path/nonexistent.txt';
  ...
  test('should return file content if file exists', async () => {
    ...
    const expectedFullPath = '/mock/path/existing.txt';
    ...
    expect(mockedExistsSync).toHaveBeenCalledWith(expectedFullPath);
